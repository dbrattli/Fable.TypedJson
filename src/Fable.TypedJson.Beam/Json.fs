...
let inline validateMapWithCaseRules<'T> (caseRules: CaseRules) (map: Map<string, string>) : Result<'T, FieldError list> =
    Fable.TypedJson.Json.validateMapWithCaseRules<'T> beam caseRules map
...
let inline jsonSchemaValueOf<'T> (registry: CodecRegistry) (caseRules: CaseRules) : JsonSchemaValue =
    Fable.TypedJson.JsonSchemaGen.jsonSchemaValueOf<'T> beam registry caseRules
...
let inline jsonSchemaWithDefsOf<'T>
    ...
    Fable.TypedJson.JsonSchemaGen.jsonSchemaWithDefsOf<'T> beam registry caseRules refPrefix
...
let inline jsonSchemaWithDefsOfCodec<'T>
    ...
    (refPrefix: string)
    : JsonSchemaValue * Map<string, JsonSchemaValue> =
    Fable.TypedJson.JsonSchemaGen.jsonSchemaWithDefsOfCodec<'T> beam registry codec refPrefix
